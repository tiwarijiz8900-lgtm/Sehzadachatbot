import random
from PRITI_CHATBOT.database import get_served_chats
...
@PRITI_CHATBOT.on_message(filters.command(SHAYRI_COMMAND))
            ...
            [
                [
                    InlineKeyboardButton(
                        "❍ 𝐒ᴜᴘᴘᴏʀᴛ ❍", url=f"https://t.me/LuckyXSupport"
                    ),
                    InlineKeyboardButton(
                        "❍ 𝐔ᴘᴅᴀᴛᴇ ❍", url=f"https://t.me/Luckyxupdate"
                    ),
                ]
            ]
        ),
